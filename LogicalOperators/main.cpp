...
int main( ){
	...
	cout << "Enter na integer - the bounds are " << lower << " and " << upper << " : ";
	cin >> num; 
	...
	// Determine if you need to wear a coat based ont he mperature and wind speed
	...
	wear_coat = (temperature < temperature_for_coat && wind_speed > wind_speed_for_coat);
	cout << "Do you ened to wear a coat using AND? " << wear_coat << endl; 
